...
def plot_2D(x_list,y_list,z_list,p_list,colors,Models):
    ...
    positive contrast in red (Model 1) or blue (Model 2)
    ...
    for x,y,z,p,color,Model in zip(x_list,y_list,z_list,p_list,colors,Models):
        ...
        ax[0].plot(x[idx_neg],z[idx_neg],linestyle='none',marker='.',markersize=markersize,color='green')
        ...
        ax[1].plot(y[idx_neg],z[idx_neg],linestyle='none',marker='.',markersize=markersize,color='green')
        ...
        ax[2].plot(x[idx_neg],y[idx_neg],linestyle='none',marker='.',markersize=markersize,color='green')
